...
| 2026-09-07 | Workspace pane focus ring jumps to the main window (file open / close tab vs Add to chat)           | [workspace-pane-focus-ring-jumps-to-main.md](./workspace-pane-focus-ring-jumps-to-main.md)                         |
